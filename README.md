...
## .env Structure
```.env DATABASE_URL = postgresql://[username]:[password]@localhost:5432/gcms ```
If you don't use a password for your psql, the url is just ```.env postgresql://[username]@localhost:5432/gcms```
